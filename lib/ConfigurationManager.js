...
module.exports = class ConfigurationManager {
    ...
    addConnectionConfiguration (name, description, user, server, port, path, authentication, password) {
    ...
    // 扩展
    editConnectionConfiguration (uuid, name, description, user, server, port, path, authentication, password) {
        let cc = new ConnectionConfiguration({
            'uuid': uuid,
            'name': name,
            'description': description,
