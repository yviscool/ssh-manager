...
module.exports = class ConfigurationManager {
    ...
    addConnectionConfiguration (name, description, user, server, port, path, authentication, password, remoteCommand) {
    ...
    // 扩展
    editConnectionConfiguration (uuid, name, description, user, server, port, path, authentication, password, remoteCommand) {
        let cc = new ConnectionConfiguration({
            'uuid': uuid,
            'name': name,
            'description': description,
