...
module.exports = class ConfigurationCommand extends SubCommand {
    ...
    static async _getConnectionConfigurationProperty(message, name, defaultValue = null, validationFunction = nulll, type = 'input') {
    ...
    static async _createAction() {
        ...
        // 扩展
        let password = await ConfigurationCommand._getConnectionConfigurationProperty('Password', 'password', 'root', CCValidator.validatePassword, 'password')
        ...
        let remoteCommand = await ConfigurationCommand._getConnectionConfigurationProperty('RemoteCommand', 'remoteCommand', `echo "please install lrzsz before upload/download"`, CCValidator.validateRemoteCommand)
