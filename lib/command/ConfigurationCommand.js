...
module.exports = class ConfigurationCommand extends SubCommand {
    ...
    static async _createAction () {
        ...
        cm.addConnectionConfiguration(name, description, user, server, port, path, authentication, password)
    }
    ...
    static async _editAction () {
        ...
        cm.editConnectionConfiguration(cc.uuid, name, description, user, server, port, path, authentication, password)
    }
