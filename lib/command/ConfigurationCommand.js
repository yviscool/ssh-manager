...
module.exports = class ConfigurationCommand extends SubCommand {
    ...
    static async _editAction () {
        ...
        let authentication = await ConfigurationCommand._getConnectionConfigurationAuthenticationProperty(('authentication' in cc && typeof cc.authentication !== 'undefined') ? cc.authentication : null)
