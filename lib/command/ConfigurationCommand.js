...
module.exports = class ConfigurationCommand extends SubCommand {
    ...
    static async _createAction () {
        ...
        // 扩展
        let password = await ConfigurationCommand._getConnectionConfigurationProperty('Password', 'password', 'root', CCValidator.validateUser)
        let remoteCommand = await ConfigurationCommand._getConnectionConfigurationProperty('RemoteCommand', 'remoteCommand', `echo "please install lrzsz before upload/download"`, CCValidator.validateUser)
    ...
    static async _editAction () {
        ...
        // 扩展
        let password = await ConfigurationCommand._getConnectionConfigurationProperty('Password', 'password', cc.password, CCValidator.validateUser)
        let remoteCommand = await ConfigurationCommand._getConnectionConfigurationProperty('RemoteCommand', 'remoteCommand', cc.remoteCommand, CCValidator.validateUser)
